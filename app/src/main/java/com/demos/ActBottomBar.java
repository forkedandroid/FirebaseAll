...
public class ActBottomBar extends AppCompatActivity {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                AHNotification notification = new AHNotification.Builder()
                        .setText(":)")
                        .setBackgroundColor(ContextCompat.getColor(ActBottomBar.this, R.color.color_notification_back))
                        .setTextColor(ContextCompat.getColor(ActBottomBar.this, R.color.color_notification_text))
                        .build();
     ...
     */
    public void reload() {
        startActivity(new Intent(this, ActBottomBar.class));
        finish();
    }
