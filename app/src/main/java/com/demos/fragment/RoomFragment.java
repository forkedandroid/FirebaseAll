...
import com.demos.fragment.presenter.RoomPresenter;
import com.demos.fragment.util.DensityUtil;
...
public class RoomFragment extends BaseFragment<IRoomView, RoomPresenter> implements IRoomView {
    ...
    private LoginFragment anchorInfoFragment;
    ...
    public void initUI() {
        ...
        listData.add(LoginFragment.newInstance());
        listData.add(LoginFragment.newInstance());
        anchorInfoFragment = LoginFragment.newInstance();
