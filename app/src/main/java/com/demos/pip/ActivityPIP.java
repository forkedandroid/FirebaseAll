...
import com.demos.pip.widget.MovieView;
...
@SuppressLint("NewApi")
public class ActivityPIP extends AppCompatActivity {
    ...
    void updatePictureInPictureActions(
        ...
        final PendingIntent intent =
                PendingIntent.getBroadcast(
                        ...
                        0);
        final Icon icon = Icon.createWithResource(ActivityPIP.this, iconId);
        actions.add(new RemoteAction(icon, title, title, intent));

        // Another action item. This is a fixed action.
        actions.add(
                new RemoteAction(
                        Icon.createWithResource(ActivityPIP.this, R.drawable.ic_info_24dp),
